...
namespace BookStore.Infrastructure.Data.Migrations
{
    ...
    [Migration("20250803141139_ShoppingCart_Added")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStore.Infrastructure.Data.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("ShoppingCart unique identifier");
                    ...
                    b.Property<string>("ApplicationUserId")
                        ...
                        .HasComment("ApplicationUser unique identifier");
                    ...
                    b.Property<int>("Count")
                        .HasColumnType("int")
                        .HasComment("It shows the count of the ordered books");
                    ...
                    b.ToTable("ShoppingCarts", t =>
                        {
                            t.HasComment("Represents Shopping cart in the store");
                        });
                });
            ...
            modelBuilder.Entity("BookStore.Infrastructure.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasComment("Real Name of the User");

                    b.Property<string>("PostCode")
                        .HasMaxLength(25)
                        .HasColumnType("nvarchar(25)")
                        .HasComment("Post code of the user");

                    b.ToTable(t =>
                        {
                            t.HasComment("Extended IdentityUser");
                        });
            ...
            modelBuilder.Entity("BookStore.Infrastructure.Data.Models.ShoppingCart", b =>
                {
                    b.HasOne("BookStore.Infrastructure.Data.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
